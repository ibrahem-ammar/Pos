...
<html dir="{{ LaravelLocalization::getCurrentLocaleDirection() }}">
    ...
    <body class="hold-transition sidebar-mini">
        ...
        <!-- REQUIRED SCRIPTS -->
        {{-- sweet alert --}}
        <script src=" {{ asset('admin_files/dist/js/sweetalert2.all.min.js')}} "></script>
        <!-- jQuery -->
        ...
        <script src=" {{asset('admin_files/plugins/bs-custom-file-input/bs-custom-file-input.min.js')}} "></script>
